...
For daily usage, I recommend forking [my repo](https://github.com/max-baz/dotfiles) instead of using it directly, as I am changing things on daily basis 🙂
...
- [yubikey-touch-detector](https://github.com/max-baz/yubikey-touch-detector) - a tool that can detect when your YubiKey is waiting for a touch.
- [browserpass](https://github.com/browserpass/browserpass-extension) - browser extension for `pass` and `gopass`.
- [wluma](https://github.com/max-baz/wluma) - automatic brightness adjustment based on screen contents.
...
- [arch-secure-boot](https://github.com/max-baz/arch-secure-boot) + [snap-pac](https://github.com/wesbarnett/snap-pac) - UEFI Secure Boot for Arch Linux + btrfs snapshots during system update.
