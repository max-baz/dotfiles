...
let
  ...
  noto-fonts-color-emoji-png = stdenv.mkDerivation rec {
    ...
    src = fetchFromGitHub {
      ...
      repo = "emoji-assets";
      rev = "master";
      hash = "sha256-KraTadb2WjQOEqs+kIVpwSYUD5teMdWAGw3oQ9smxPY=";
    };

    renameScript = fetchurl {
      url = "https://raw.githubusercontent.com/max-baz/docker-joypixels-fonts-build/refs/heads/main/rename_files.py";
      hash = "sha256-1WcH0Ad1gxTB5HnyMjYsZbioUif6AudqMoQR7pvY0HU=";
    };
    ...
    buildPhase = ''
      ...
      cp -r $src/png/128/*.png build/compressed_pngs/
      ${python3}/bin/python3 ${renameScript} $src/emoji.json build/compressed_pngs
  ...
  noto-emoji-sheet-32 = fetchurl {
    url = "https://max.baz.nu/sheet_joypixels_32.png";
    hash = "sha256-MGFYb+tRJws/Ynbz/oL91O8jhOoGVDUwzOTtg6iu+W8=";
  };
  noto-emoji-sheet-64 = fetchurl {
    url = "https://max.baz.nu/sheet_joypixels_64.png";
